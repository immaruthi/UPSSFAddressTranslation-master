...
namespace UPS.ServicesDataRepository
{
    public class ShipmentListService : IShipmentListAsync
    {
           ...
           foreach(var ship in List)
            {
                ...
                sLRequest.SMT_VAL_DE = ship.SMT_VAL_DE;sLRequest.SMT_WGT_DE = ship.SMT_WGT_DE;sLRequest.SPC_ADR_TE = ship.SPC_ADR_TE;
        ...
        public List<ShipperListRequest> GetShipmentWithPostalCode1(int workflowID)
        {
            List<ShipperListRequest> shipperlist = new List<ShipperListRequest>();
            optionsBuilder = new DbContextOptionsBuilder<ApplicationDbContext>();
            ...
            {
                ShipperListRequest sLRequest = new ShipperListRequest();
                sLRequest.SID = ship.c.ID;
                sLRequest.ID = ship.l.ID;
                sLRequest.BIL_TYP_TE = ship.c.BIL_TYP_TE;
                sLRequest.CCY_VAL_TE = ship.c.CCY_VAL_TE;
                sLRequest.COD_TE = ship.c.COD_TE;
                sLRequest.CSG_CTC_TE = ship.c.CSG_CTC_TE;
                sLRequest.DIM_WGT_DE = ship.c.DIM_WGT_DE;
                sLRequest.DST_CTY_TE = ship.c.DST_CTY_TE;
                sLRequest.DST_PSL_TE = ship.c.DST_PSL_TE;
                sLRequest.EXP_SLC_CD = ship.c.EXP_SLC_CD;
                sLRequest.EXP_TYP = ship.c.EXP_TYP;
                sLRequest.FST_INV_LN_DES_TE = ship.c.FST_INV_LN_DES_TE;
                sLRequest.IMP_NR = ship.c.IMP_NR;
                sLRequest.IMP_SLC_TE = ship.c.IMP_SLC_TE;
                sLRequest.IN_FLG_TE = ship.c.IN_FLG_TE;
                sLRequest.ORG_CTY_TE = ship.c.ORG_CTY_TE;
                sLRequest.ORG_PSL_CD = ship.c.ORG_PSL_CD;
                sLRequest.OU_FLG_TE = ship.c.OU_FLG_TE;
                sLRequest.PCS_QTY_NR = ship.c.PCS_QTY_NR;
                sLRequest.PH_NR = ship.c.PH_NR;
                sLRequest.PKG_NR_TE = ship.c.PKG_NR_TE;
                sLRequest.PKG_WGT_DE = ship.c.PKG_WGT_DE;
                sLRequest.PK_UP_TM = ship.c.PK_UP_TM;
                sLRequest.PYM_MTD = ship.c.PYM_MTD;
                sLRequest.PY_MT_TE = ship.c.PY_MT_TE;
                sLRequest.QQS_TRA_LG_ID = ship.c.QQS_TRA_LG_ID;
                sLRequest.RCV_ADR_TE = ship.c.RCV_ADR_TE;
                sLRequest.RCV_CPY_TE = ship.c.RCV_CPY_TE;
                sLRequest.SF_TRA_LG_ID = ship.c.SF_TRA_LG_ID;
                sLRequest.SHP_ADR_TE = ship.c.SHP_ADR_TE;
                sLRequest.SHP_ADR_TR_TE = ship.c.SHP_ADR_TR_TE;
                sLRequest.SHP_CPY_NA = ship.c.SHP_CPY_NA;
                sLRequest.SHP_CTC_TE = ship.c.SHP_CTC_TE;
                sLRequest.SHP_DT = ship.c.SHP_DT;
                sLRequest.SHP_NR = ship.c.SHP_NR; sLRequest.SHP_PH_TE = ship.c.SHP_PH_TE; sLRequest.SMT_NR_TE = ship.c.SMT_NR_TE;
                sLRequest.SMT_STA_NR = ship.c.SMT_STA_NR;
                sLRequest.SMT_VAL_DE = ship.c.SMT_VAL_DE; sLRequest.SMT_WGT_DE = ship.c.SMT_WGT_DE; sLRequest.SPC_ADR_TE = ship.l.SPC_ADR_TE;
                sLRequest.SPC_CPY_TE = ship.l.SPC_CPY_TE; sLRequest.SPC_CTC_PH = ship.l.SPC_CTC_PH;
                sLRequest.SPC_CTR_TE = ship.l.SPC_CTR_TE; sLRequest.SPC_CTY_TE = ship.l.SPC_CTY_TE;
                sLRequest.SPC_NA = ship.l.SPC_NA;
                sLRequest.SPC_PSL_CD_TE = ship.l.SPC_PSL_CD_TE; sLRequest.SPC_SLIC_NR = ship.l.SPC_SLIC_NR;
                sLRequest.SPC_SND_PTY_CTC_TE = ship.l.SPC_SND_PTY_CTC_TE; sLRequest.SVL_NR = ship.c.SVL_NR;
                sLRequest.WFL_ID = ship.c.WFL_ID;
                sLRequest.WGT_UNT_TE = ship.c.WGT_UNT_TE;
